...
public class Stepdefs {
    ...
    public void existingAccountWorks(String user, String password) {
        newUsernameAndPasswordAreEntered(user, password);
    ...
    @When("username {string} with password {string} is entered")
    public void existingAccountWorks2(String username, String password) {
       inputLines.add(username);
       inputLines.add(password);
